...
import LockReaderContextInfo from './LockReaderContextInfo'
...
const tabs = [
    ...
    },
    {
        name: 'Info',
        index: 1,
        component: <LockReaderContextInfo />,
    },
]
...
class LockReaderContext extends React.PureComponent {
    constructor(props) {
        super(props)
...
export default connect(mapStateToProps, mapDispatchToProps)(withStyles(styles)(LockReaderContext))
