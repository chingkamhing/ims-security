...
import { selectActivityOperationList } from '../../store/reducers'
import { CONF } from '../../constants'

// table title
const TITLE = 'Operation Activity'
...
const ActivityOperation = (props) => {
    const activityLogs = useSelector(selectActivityOperationList)
