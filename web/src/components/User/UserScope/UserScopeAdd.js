...
const UserScopeAdd = (props) => {
    ...
    return (
        <form noValidate autoComplete="off">
            <Dialog open={open} onClose={onCancel} aria-labelledby="new-scope-title">
                <DialogTitle id="new-scope-title">{TITLE}</DialogTitle>
